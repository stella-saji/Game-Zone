# Game-Zone
A collection of simple and fun mini games built using Python. This repository is perfect for beginners who want to learn programming through interactive projects while strengthening their understanding of logic, loops, and conditions.  Each game is designed to be lightweight, easy to understand, and beginner-friendly. 
The games in this repo are:

 # 1. Math_Challenge_Game.py :
 
   This is a simple interactive math game where the player solves a series of randomly generated addition problems. The game consists of five questions, and the player must enter the correct answer for each. It also includes input validation to ensure only valid numbers are accepted. At the end, the game displays the final score along with the total time taken, encouraging both accuracy and speed.
